...
import { registerUser } from '../apiCalls/createUser';
...
const RegisterForm = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        const fisrtName = data.get("firstName");
        ...
        try {
            await registerUser(fisrtName, lastName, email, password, role);
            navigate("/login");
        ...
        <Box sx={{ marginTop: 8, display: 'flex', flexDirection: 'column', alignItems: 'center', }}>
          ...
          <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <FormControl fullWidth required>
                    ...
                    <Select labelId="role-label" id="role" name="role" defaultValue="user" label="Role" >
            ...
            <Grid container justifyContent="flex-end">
              <Grid item>
                <Link to="/login" variant="body2" style={{textDecoration:"none", color:"#FFA500"}}>
